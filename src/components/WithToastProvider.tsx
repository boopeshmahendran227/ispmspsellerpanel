...
type ToastProviderProps = StateProps & DispatchProps;

function withToastProvider(Component) {
  function WithToastProvider(props: ToastProviderProps) {
    return (
      <>
        <Component {...props} />
        <Portal>
  ...
  hoistNonReactStatics(WithToastProvider, Component);
  ...
  return connect(mapStateToProps, mapDispatchToProps)(WithToastProvider);
}
